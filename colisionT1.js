...
function OnCollisionEnter(collision : Collision) {
		...
		if (globalVar.BarraT1==2){
			v100.texture = v80;	
			}
		if (globalVar.BarraT1==3){
			v100.texture = v70;	
			}
		if (globalVar.BarraT1==4){
			v100.texture = v60;	
			}
		if (globalVar.BarraT1==5){
			v100.texture = v50;	
			}
		if (globalVar.BarraT1==6){
			v100.texture = v40;	
			}
		if (globalVar.BarraT1==7){
			v100.texture = v30;	
			}
		if (globalVar.BarraT1==8){
			v100.texture = v20;	
			}
		if (globalVar.BarraT1==9){
			v100.texture = v10;	
			}
		if (globalVar.BarraT1==10){
			ko.texture = ko2;
