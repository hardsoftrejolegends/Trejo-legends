...
static private var tapTimeDelta : float = 0.5;				// Time allowed between taps
...
function SetPos(ex : float,ye : int)
{
	gui.pixelInset.x = Screen.width - (gui.pixelInset.width + 10) * ex-10;
	gui.pixelInset.y = (gui.pixelInset.height)*ye+10;
	
	defaultRect = gui.pixelInset;	
	touchZone = defaultRect;
}

function Set(ex, ye, w, h){
	gui.pixelInset.width = w;
	gui.pixelInset.height = h;
