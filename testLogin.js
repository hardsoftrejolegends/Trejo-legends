public var DatabaseName : String = "Users.sqdb";
...
function OnGUI(){        
        //firstName = GUI.TextField (Rect (Screen.width/2 - 200, Screen.height/2 - 50, 400, 40), firstName, DatabaseEntryStringWidth);
        //lastName = GUI.PasswordField (Rect (Screen.width/2 - 200, Screen.height/2 + 40, 400, 40), lastName, "*"[0], DatabaseEntryStringWidth);
    ...
    // This first block allows us to enter new entries into our table
        ...
        GUILayout.EndHorizontal();
 		...
 		//Visualizacion del contenido de la BD
